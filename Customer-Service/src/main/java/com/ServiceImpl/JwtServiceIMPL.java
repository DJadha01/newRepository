...
public class JwtServiceIMPL implements JwtService {
	...
	@Override
	public String generateToken(CustomeUserService userDetails) {
		log.debug("generateToken({})", userDetails.getEmail());
		return generateToken(new HashMap<>(), userDetails);
	}

	@Override
	public String generateToken(Map<String, Object> extraClaims, CustomeUserService userDetails) {
	...
	private String buildToken(Map<String, Object> extraClaims, CustomeUserService userDetails, long expiration) {
	...
	@Override
	public boolean isTokenValid(String token, CustomeUserService userDetails) {
